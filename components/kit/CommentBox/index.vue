  ...
  <div class="comments-from">
    <div class="comments-form-body">
      <div class="comments-form-user">
        ...
        <el-button v-else theme="text" style="width: 60px;padding:4px 0;" @click="handleLogin">加入我们</el-button>
      </div>
    ...
    <div class="comments-form-footer">
      <div class="comments-form-footer-btns">
        <button class="mo-btns"  @blur="handleBlur" >
          <SvgIcon icon='emotion' class="svg_icon" @click.native="handleClick" />
      ...
      <el-button :loading="isAddCommentLoading" theme="gradient" shape="rect" @click="handleComment">{{ upId ? '回复' : '发布' }}</el-button>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    /* 评论 */
    handleComment() {
      if(!this.userInfo) return this.toggleSignInModal()
